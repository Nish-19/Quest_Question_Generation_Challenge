# %%
'''
python -m code.finetune.Bart.bart_finetune \
...
# Tokenization
def get_encoding(model_name, t5_inputs, question):
    tokenizer = BartTokenizer.from_pretrained(model_name)
...
def add_params():
    ...
    parser.add_argument("-L", "--learning_rate", type=float, default=3e-5, help="Learning Rate for training the Transformer Model")
    ...
    parser.add_argument("-M", "--model_name", type=str, default="bart-base", help="Variant of the Transformer model for finetuning")
...
if __name__ == '__main__':
    ...
    model = FinetuneTransformer(model_name = args.model_name, training_dl=training_dataloader, 
